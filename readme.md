...
struct MyStruct { 
    ...
    int offset
readonly 
    // These properties can only be modified within this module
    // but can be read from any module
    int length
...
public
    ...
    // Main constructor (will be generated if you don't provide one)
    new {
...
// Access the static property/function
MyStruct.counter += 1
var c = MyStruct.count()
